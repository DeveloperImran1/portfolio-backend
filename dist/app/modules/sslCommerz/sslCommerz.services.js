...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // jeheto aikhane axios package use kore post korar korar kaj kortese. Tai axios npm ke install korte hobe: npm i axios
        ...
        throw new AppError_1.default(http_status_codes_1.default.BAD_GATEWAY, error.message);
    }
});
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, axios_1.default)({
            method: "GET",
            url: `${env_1.envVars.SSL.SSL_VALIDATION_API}?val_id=${payload.val_id}&store_id=${env_1.envVars.SSL.SSL_STORE_ID}&store_password=${env_1.envVars.SSL.SSL_STORE_PASS}`,
        });
        console.log("SSL commerz validate api response ", response.data); // aita localhost a thaka obosthai asbena, so deploy korar por vercel er terminal theke dekhte hobe.
        ...
        console.log(error);
        throw new AppError_1.default(http_status_codes_1.default.BAD_GATEWAY, `Payment validation error ${error.message}`);
    }
});
