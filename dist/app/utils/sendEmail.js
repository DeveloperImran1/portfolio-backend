...
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, subject, templateName, templateData, attachments, }) {
    try {
        ...
        const html = yield ejs_1.default.renderFile(templatePath, templateData); // ejs npm package er maddhome templatePath and oi file a dynamic data gulo send korar jonno templateData object akare dita hobe. Tahole fully akta dynamic html file generate kore diba.
